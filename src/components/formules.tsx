      ...
      <Card className="mt-6 w-96">
        ...
        <CardBody>
          ...
          <Typography>
            ...
            physique présente de nombreux bienfaits sur le plan mental. Elle
            permet de développer la concentration, la discipline, la maîtrise et
            le dépassement de soi, ce qui peut avoir un impact positif sur
